...
use crate::target::{rtc0, RTC0, RTC1};
    ...
    T: RtcExt,
{
    ...
    pub fn enable_interrupt(&mut self, int: RtcInterrupt) {
        match int {
            RtcInterrupt::Tick => {
                self.periph.intenset.write(|w| w.tick().set())
            }
            RtcInterrupt::Overflow => {
                self.periph.intenset.write(|w| w.ovrflw().set())
            }
            RtcInterrupt::Compare0 => {
                self.periph.intenset.write(|w| w.compare0().set())
            }
            RtcInterrupt::Compare1 => {
                self.periph.intenset.write(|w| w.compare1().set())
            }
            RtcInterrupt::Compare2 => {
                self.periph.intenset.write(|w| w.compare2().set())
            }
            RtcInterrupt::Compare3 => {
                self.periph.intenset.write(|w| w.compare3().set())
            }
        }
    }
    ...
    pub fn disable_interrupt(&mut self, int: RtcInterrupt) {
        match int {
            RtcInterrupt::Tick => {
                self.periph.intenclr.write(|w| w.tick().clear())
            }
            RtcInterrupt::Overflow => {
                self.periph.intenclr.write(|w| w.ovrflw().clear())
            }
            RtcInterrupt::Compare0 => {
                self.periph.intenclr.write(|w| w.compare0().clear())
            }
            RtcInterrupt::Compare1 => {
                self.periph.intenclr.write(|w| w.compare1().clear())
            }
            RtcInterrupt::Compare2 => {
                self.periph.intenclr.write(|w| w.compare2().clear())
            }
            RtcInterrupt::Compare3 => {
                self.periph.intenclr.write(|w| w.compare3().clear())
            }
        }
    }
    ...
    pub fn enable_event(&mut self, evt: RtcInterrupt) {
        match evt {
            RtcInterrupt::Tick => {
                self.periph.evtenset.write(|w| w.tick().set())
            }
            RtcInterrupt::Overflow => {
                self.periph.evtenset.write(|w| w.ovrflw().set())
            }
            RtcInterrupt::Compare0 => {
                self.periph.evtenset.write(|w| w.compare0().set())
            }
            RtcInterrupt::Compare1 => {
                self.periph.evtenset.write(|w| w.compare1().set())
            }
            RtcInterrupt::Compare2 => {
                self.periph.evtenset.write(|w| w.compare2().set())
            }
            RtcInterrupt::Compare3 => {
                self.periph.evtenset.write(|w| w.compare3().set())
            }
        }
    }
    ...
    pub fn disable_event(&mut self, evt: RtcInterrupt) {
        match evt {
            RtcInterrupt::Tick => {
                self.periph.evtenclr.write(|w| w.tick().clear())
            }
            RtcInterrupt::Overflow => {
                self.periph.evtenclr.write(|w| w.ovrflw().clear())
            }
            RtcInterrupt::Compare0 => {
                self.periph.evtenclr.write(|w| w.compare0().clear())
            }
            RtcInterrupt::Compare1 => {
                self.periph.evtenclr.write(|w| w.compare1().clear())
            }
            RtcInterrupt::Compare2 => {
                self.periph.evtenclr.write(|w| w.compare2().clear())
            }
            RtcInterrupt::Compare3 => {
                self.periph.evtenclr.write(|w| w.compare3().clear())
            }
        }
    }
